        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="card-title mb-0">Unit Logistik</h5>
                        <small class="text-muted">Manajemen unit usaha logistik</small>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Daftar Unit Logistik</h5>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">Belum ada unit logistik</h5>
                            <p class="text-muted">Tambahkan unit logistik pertama untuk memulai</p>
                            <a href="{{ route('admin.units.create') }}" class="btn btn-primary">
                                <i class="ti ti-plus me-1"></i> Tambah Unit Logistik
                            </a>
                        </div>
                    @endif
                </div>
