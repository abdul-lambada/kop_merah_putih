        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="card-title mb-0">Unit Sembako</h5>
                        <small class="text-muted">Manajemen unit usaha sembako</small>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Daftar Unit Sembako</h5>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            <div class="mb-3">
                                <i class="ti ti-shopping-cart-plus text-muted" style="font-size: 4rem;"></i>
                            </div>
                            <h5 class="text-muted">Belum ada unit sembako</h5>
                            <p class="text-muted">Tambahkan unit sembako pertama untuk memulai</p>
                            <a href="{{ route('admin.units.create') }}" class="btn btn-primary">
                                <i class="ti ti-plus me-1"></i> Tambah Unit Sembako
                            </a>
                        </div>
                    @endif
                </div>
