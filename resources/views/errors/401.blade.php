...
>
  <head>
    ...
    <title>Unauthorized - 401 | Koperasi Merah Putih</title>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <div class="text-center">
          <h2 class="mb-2">401</h2>
          <h4 class="mb-3">Unauthorized</h4>
          <p class="mb-4">Please login to access this page.</p>
          ...
          <div class="alert alert-info mb-4 text-start">
            ...
            <p class="mb-0">You need to be logged in to view this page.</p>
          </div>
