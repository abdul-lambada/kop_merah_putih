...
>
  <head>
    ...
    <title>Server Error - 500 | Koperasi Merah Putih</title>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <div class="text-center">
          ...
          <p class="mb-4">Something went wrong on our end.</p>
          ...
          <div class="alert alert-danger mb-4 text-start">
            ...
            <p class="mb-0">An unexpected error occurred. Our team has been notified and is working on a fix.</p>
          </div>
